...
const StatusBadge = ({ status }: { status: string }) => {
    ...
    return (
        <span className={`inline-flex items-center gap-2 text-sm px-3 py-1 rounded-full border w-fit ${
            isActive
            ...
            <div className="min-h-screen bg-background/50 backdrop-blur-sm" style={{
                ...
                <main className="pt-24 pb-16 px-4 md:px-8 lg:px-16 container mx-auto relative">
                    <div className="flex flex-col gap-2 mb-16">
                        <span className="text-xs font-semibold uppercase tracking-widest text-foreground/40">Portfolio</span>
                        <h1 className="text-5xl md:text-6xl font-bold font-fira-code text-foreground">Products</h1>
                        <p className="text-lg text-foreground/60 mt-1">Independently built, architected, and taken to production.</p>
                    </div>
