...
export const AboutSection = () => {
  ...
  return (
    <section className="min-h-screen pt-25 w-full container mx-auto flex flex-col items-center px-8 pb-10">
      ...
      <div id="blog-detail" className="flex flex-col lg:flex-row items-start justify-center w-full gap-8 pt-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-4">
            {sections.map((section) => (
              <button
                ...
                className={`p-2 px-4 text-center rounded-lg border border-callout text-callout transition-colors duration-300 ${
